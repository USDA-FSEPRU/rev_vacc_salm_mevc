#!/bin/bash
#SBATCH --job-name=Step_7c_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_3
#SBATCH -p ceres
#SBATCH --array=1-28
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 2
#SBATCH -t 1:00:00
#SBATCH -o "Step_7c_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_3.stdout.%j.%N"
#SBATCH -e "Step_7c_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_3.stderr.%j.%N" 
...
#Run the RScript
Rscript PulseNet_proteome_blasting_summaries_Step_3.R $summary_file $epitope_unique_id
