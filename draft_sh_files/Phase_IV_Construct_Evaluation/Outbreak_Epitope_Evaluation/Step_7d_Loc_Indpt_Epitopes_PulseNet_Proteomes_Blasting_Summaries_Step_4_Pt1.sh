#!/bin/bash
#SBATCH --job-name=Step_7d_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_4
#SBATCH -p ceres
#SBATCH --array=3-28
#SBATCH -N 1
#SBATCH -n 1
#SBATCH -c 2
#SBATCH -t 1:00:00
#SBATCH -o "Step_7d_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_4.stdout.%j.%N"
#SBATCH -e "Step_7d_Loc_Indpt_Epitopes_PulseNet_Proteomes_Blasting_Summaries_Step_4.stderr.%j.%N" 
...
#Run the RScript
Rscript PulseNet_proteome_blasting_summaries_Step_4.R $summary_file $epitope_unique_id
