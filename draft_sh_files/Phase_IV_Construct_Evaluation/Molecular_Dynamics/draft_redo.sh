#!/bin/bash
#SBATCH --job-name=Loc_Indpdt_TLR5_Complex_post_md_prod_run
#SBATCH -p long
#SBATCH --mem=144gb
#SBATCH -N 1
#SBATCH -n 72
#SBATCH -o "Loc_Indpdt_TLR5_Complex_post_md_prod_run.stdout.%j.%N"
#SBATCH -e "Loc_Indpdt_TLR5_Complex_post_md_prod_run.stderr.%j.%N"
...
#Make an index of the topology file
gmx make_ndx -f md.tpr -o Chain_A_index.ndx
#Separate your residues
#Do RMSF Analysis by -n index
gmx rmsf -s md.tpr -f md_noPBC.xtc -n index.ndx -o rmsf.xvg